...
int main(int argc, char *argv[]) {
    ...
    string meshType = parameterListProblem->sublist("Parameter")
                          .get("Mesh Type", "unstructured");
    string meshName = parameterListProblem->sublist("Parameter")
                          .get("Mesh Name", "simple_square.mesh");
    ...
    /**/
    /*     exPara->setup("solutionGraphPartitioning", domain->getMesh(),
     * FEType); */
...
void solve() {
    ...
    RCP<Xpetra::CrsGraph<LO, GO, NO>> overlappingDualGraph;
    /* RCP<LHelementList; */
    /* buildAndExtendDualGraphPartition(elementList, dualGraphPartition); */
...
// elementList: global list of elements in the mesh
// dualGraphPartition: array containing partitioning of the dual graph
/* void buildAndExtendDualGraphPartition(elementList, dualGraphPartition) { */
// Use an existing partition generated by the FEDDLib or do the partitioning
// here?
